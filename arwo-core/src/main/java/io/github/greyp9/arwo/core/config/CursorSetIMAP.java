...
// i18nf
public final class CursorSetIMAP {
    ...
    public CursorSetIMAP(final Xed xed) throws IOException {
    ...
    private static class Const {
        private static final String SELECT_ALL = "/app:app/app:imapServers/app:server";
    }
}

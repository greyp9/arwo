...
// i18nf
public final class CursorSetCIFS {
    ...
    public CursorSetCIFS(final Xed xed) throws IOException {
    ...
    private static class Const {
        private static final String SELECT_ALL = "/app:app/app:cifsServers/app:server";
    }
}

...
public final class CursorIMAP {
    ...
    public CursorIMAP(final XedCursor cursor) {
        this.cursor = cursor;
    }

    public CursorIMAP(final Xed xed, final String name) throws IOException {
    ...
    private static class Const {
        private static final String SELECT_BY_NAME = "/app:app/app:imapServers/app:server[app:name/text()='%s']";
    }
}

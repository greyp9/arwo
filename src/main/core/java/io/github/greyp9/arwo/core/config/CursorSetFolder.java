...
// i18nf
public final class CursorSetFolder {
    ...
    public CursorSetFolder(final Xed xed) throws IOException {
    ...
    private static class Const {
        private static final String SELECT_ALL = "/app:app/app:folders/app:folder";
    }
}

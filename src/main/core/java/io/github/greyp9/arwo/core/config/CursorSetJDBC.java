...
// i18nf
public final class CursorSetJDBC {
    ...
    public CursorSetJDBC(final Xed xed) throws IOException {
    ...
    private static class Const {
        private static final String SELECT_ALL = "/app:app/app:jdbcServers/app:server";
    }
}

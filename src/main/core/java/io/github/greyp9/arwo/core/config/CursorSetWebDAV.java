...
// i18nf
public final class CursorSetWebDAV {
    ...
    public CursorSetWebDAV(final Xed xed) throws IOException {
    ...
    private static class Const {
        private static final String SELECT_ALL = "/app:app/app:webdavServers/app:server";
    }
}

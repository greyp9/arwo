...
public class JDBCServlet extends javax.servlet.http.HttpServlet {
    ...
    protected final void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new JDBCHandlerGet(httpRequest, userState).doGet();
        // send response
    ...
    protected final void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new JDBCHandlerPost(httpRequest, userState).doPost();
        // send response

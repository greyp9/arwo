...
public class DashServlet extends javax.servlet.http.HttpServlet {
    ...
    protected final void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new DashHandlerGet(httpRequest, userState).doGet();
        // send response
    ...
    protected final void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new DashHandlerPost(httpRequest, userState).doPost();
        // send response

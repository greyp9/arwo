package io.github.greyp9.arwo.app.mail.pop3.cron;

import io.github.greyp9.arwo.app.core.state.AppState;
import io.github.greyp9.arwo.app.core.state.AppUserState;
import io.github.greyp9.arwo.app.mail.pop3.handler.POP3HandlerGet;
...
public class POP3Runnable extends CronRunnable {
    private final Logger logger = Logger.getLogger(getClass().getName());

    public POP3Runnable(final CronParams params) {
        super(params);
    }
    ...
    public final void run() {
        ...
        try {
            ...
            final String resourceFull = getParams().getContext() + App.Servlet.POP3 + pathInfo;
    ...
    private ServletHttpRequest getServletHttpRequest(
        ...
        return new ServletHttpRequest(httpRequest, date, principal, context, App.Servlet.POP3, pathInfo);
    }

...
public abstract class POP3View {
    ...
    public final POP3Request getRequest() {
        return request;
    }
    ...
    public POP3View(final POP3Request request, final AppUserState userState) {
    ...
    protected final POP3DataSource getDataSource() throws IOException {
        final String server = request.getServer();
        final POP3ConnectionFactory factory = new POP3ConnectionFactory(httpRequest, userState, bundle, alerts);
        final ConnectionCache cachePOP3 = userState.getMail().getCachePOP3();
        final POP3ConnectionResource resource = (POP3ConnectionResource) cachePOP3.getResource(server, factory);
        return new POP3DataSource(resource.getConnection(), alerts);
    }

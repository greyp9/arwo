package io.github.greyp9.arwo.app.vis.servlet;

import io.github.greyp9.arwo.app.core.servlet.ServletU;
import io.github.greyp9.arwo.app.core.state.AppState;
import io.github.greyp9.arwo.app.core.state.AppUserState;
import io.github.greyp9.arwo.app.vis.handler.VisualizationHandlerGet;
import io.github.greyp9.arwo.app.vis.handler.VisualizationHandlerPost;
...
public class VisualizationServlet extends javax.servlet.http.HttpServlet {
    ...
    protected final void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new VisualizationHandlerGet(httpRequest, userState).doGetSafe();
        // send response
    ...
    protected final void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new VisualizationHandlerPost(httpRequest, userState).doPostSafe();
        // send response

...
import io.github.greyp9.arwo.core.config.CursorSetSMTP;
...
public class SMTPInventoryView {
    private final ServletHttpRequest httpRequest;
    private final AppUserState userState;
    private final String offsetURI;

    public SMTPInventoryView(
    ...
    private RowSetMetaData createMetaData() {
        ...
        return new RowSetMetaData("server.smtpServerType", columns);
    }
    ...
    private RowSet createRowSet(final RowSetMetaData metaData, final Xed xed) throws IOException {
        ...
        final Collection<XedCursor> cursors = new CursorSetSMTP(xed).getCursors();
    ...
    private void createRow(final RowSet rowSet, final String baseURI, final XedCursor cursor) {
        final CursorSMTP cursorIt = new CursorSMTP(cursor);

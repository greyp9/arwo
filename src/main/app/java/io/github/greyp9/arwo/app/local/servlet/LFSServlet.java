...
public class LFSServlet extends javax.servlet.http.HttpServlet {
    ...
    protected final void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new LFSHandlerGet(httpRequest, userState).doGet();
        // send response
    ...
    protected final void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new LFSHandlerPost(httpRequest, userState).doPost();
        // send response

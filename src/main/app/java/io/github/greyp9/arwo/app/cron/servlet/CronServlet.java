package io.github.greyp9.arwo.app.cron.servlet;

import io.github.greyp9.arwo.app.core.servlet.ServletU;
import io.github.greyp9.arwo.app.core.state.AppState;
import io.github.greyp9.arwo.app.core.state.AppUserState;
import io.github.greyp9.arwo.app.cron.handler.CronHandlerGet;
import io.github.greyp9.arwo.app.cron.handler.CronHandlerPost;
...
public class CronServlet extends javax.servlet.http.HttpServlet {
    private static final long serialVersionUID = -4873733082407649612L;
    ...
    protected final void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new CronHandlerGet(httpRequest, userState).doGetSafe();
        // send response
    ...
    protected final void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new CronHandlerPost(httpRequest, userState).doPostSafe();
        // send response

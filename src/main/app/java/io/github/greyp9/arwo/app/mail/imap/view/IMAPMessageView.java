...
public class IMAPMessageView extends IMAPView {

    public IMAPMessageView(final IMAPRequest request, final AppUserState userState) {
    ...
    protected final HttpResponse addContentTo(final Element html) throws IOException {
        ...
        final RowSetMetaData metaDataFolders = IMAPDataSource.getFoldersMetaData();
        final RowSetMetaData metaDataMessages = IMAPDataSource.getMessagesMetaData();

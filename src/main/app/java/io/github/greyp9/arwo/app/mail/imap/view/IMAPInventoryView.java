...
import io.github.greyp9.arwo.core.config.CursorSetIMAP;
...
public class IMAPInventoryView {
    private final ServletHttpRequest httpRequest;
    private final AppUserState userState;
    private final String offsetURI;

    public IMAPInventoryView(
    ...
    private RowSetMetaData createMetaData() {
        final ColumnMetaData[] columns = new ColumnMetaData[] {
                ...
                new ColumnMetaData(App.Settings.PROTOCOL, Types.VARCHAR),
                new ColumnMetaData(App.Settings.HOST, Types.VARCHAR),
                new ColumnMetaData(App.Settings.PORT, Types.INTEGER),
                new ColumnMetaData(App.Settings.USER, Types.VARCHAR),
        };
        return new RowSetMetaData("server.imapServerType", columns);
    }
    ...
    private RowSet createRowSet(final RowSetMetaData metaData, final Xed xed) throws IOException {
        ...
        final Collection<XedCursor> cursors = new CursorSetIMAP(xed).getCursors();
    ...
    private void createRow(final RowSet rowSet, final String baseURI, final XedCursor cursor) {
        final CursorIMAP cursorIt = new CursorIMAP(cursor);

...
public class SFTPHandlerPost {
    ...
    public SFTPHandlerPost(final ServletHttpRequest httpRequest, final AppUserState userState) {
    ...
    public final HttpResponse doPost() throws IOException {
        ...
        if (contentType == null) {
            ...
            final SFTPHandlerPostMultipart handler = new SFTPHandlerPostMultipart(request, userState);

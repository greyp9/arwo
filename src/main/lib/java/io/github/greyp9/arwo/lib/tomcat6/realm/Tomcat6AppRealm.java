package io.github.greyp9.arwo.lib.tomcat6.realm;
...
public class Tomcat6AppRealm implements org.apache.catalina.Realm, AppRealmContainer {
    ...
    public final String getInfo() {
        return standardContext.getInfo();
    }
    ...
    @Override
    public final Principal authenticate(final String username, final byte[] credentials) {
        return null;
    }
    ...
    @Override
    public final boolean hasRole(final Principal principal, final String role) {

...
public class Authenticator {
    ...
    private static class Const {
        private static final String PUBLIC_KEY = "publickey";  // i18n lib
        private static final String INTERACTIVE = "keyboard-interactive";  // i18n lib
        private static final String PASSWORD = "password";  // i18n lib
    }
}

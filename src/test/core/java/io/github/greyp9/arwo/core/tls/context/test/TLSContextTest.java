...
public class TLSContextTest {
    ...
    public void testDefaultTrustNegative() throws IOException, GeneralSecurityException {
        ...
        try {
            ...
            Assertions.fail("SSLHandshakeException / ValidatorException expected");
        } catch (SSLHandshakeException e) {
            logger.severe(e.getMessage());
            //Assertions.assertTrue(e.getMessage().contains("ValidatorException"));  // updated message
        } catch (Exception e) {
            logger.severe(e.getMessage());
            Assertions.fail("SSLHandshakeException / ValidatorException expected");
        }
    ...
    public void testExplicitTrust() throws GeneralSecurityException, IOException {
        ...
        //Assertions.assertEquals(HttpURLConnection.HTTP_UNAUTHORIZED, httpResponse.getStatusCode());
    }

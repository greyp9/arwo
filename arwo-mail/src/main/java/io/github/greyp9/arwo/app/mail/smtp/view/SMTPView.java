...
public abstract class SMTPView {
    private final SMTPRequest request;
    private final ServletHttpRequest httpRequest;
    private final AppUserState userState;
    private final Bundle bundle;

    public final SMTPRequest getRequest() {
        return request;
    }
    ...
    public SMTPView(final SMTPRequest request, final AppUserState userState) {
...
*/
        ...
        final XedCursor cursorFavorites = nav.findX("/app:favorites/app:smtpFavorites");  // i18n xpath
        final XedCursor ignoredCursorType = nav.find("smtpFavorite", cursorFavorites);  // i18n xpath
/*

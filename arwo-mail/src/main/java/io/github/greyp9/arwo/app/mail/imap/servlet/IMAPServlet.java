package io.github.greyp9.arwo.app.mail.imap.servlet;
...
import io.github.greyp9.arwo.app.mail.imap.handler.IMAPHandlerPost;
...
public class IMAPServlet extends javax.servlet.http.HttpServlet {
    private static final long serialVersionUID = 7358590297537156674L;
    ...
    protected final void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new IMAPHandlerGet(httpRequest, userState).doGetSafe();
        // send response
    ...
    protected final void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new IMAPHandlerPost(httpRequest, userState).doPostSafe();
        // send response

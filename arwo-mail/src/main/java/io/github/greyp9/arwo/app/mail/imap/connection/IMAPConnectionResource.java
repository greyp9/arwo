...
public class IMAPConnectionResource implements ConnectionResource, Comparable<ConnectionResource> {
    ...
    public IMAPConnectionResource(final String name, final IMAPConnection connection) {
        this.name = name;

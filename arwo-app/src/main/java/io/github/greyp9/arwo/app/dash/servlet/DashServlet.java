package io.github.greyp9.arwo.app.dash.servlet;

import io.github.greyp9.arwo.app.core.servlet.ServletU;
import io.github.greyp9.arwo.app.core.state.AppState;
import io.github.greyp9.arwo.app.core.state.AppUserState;
import io.github.greyp9.arwo.app.dash.handler.DashHandlerGet;
import io.github.greyp9.arwo.app.dash.handler.DashHandlerPost;
...
public class DashServlet extends javax.servlet.http.HttpServlet {
    private static final long serialVersionUID = 8517001218487464299L;
    ...
    protected final void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new DashHandlerGet(httpRequest, userState).doGetSafe();
        // send response
    ...
    protected final void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new DashHandlerPost(httpRequest, userState).doPostSafe();
        // send response

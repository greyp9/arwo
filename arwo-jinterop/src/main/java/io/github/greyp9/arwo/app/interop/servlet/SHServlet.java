...
public class SHServlet extends javax.servlet.http.HttpServlet {
    private static final long serialVersionUID = -4764216032767063525L;
    ...
    protected final void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final HttpResponse httpResponse = new SHHandlerGet(httpRequest, userState).doGetSafe();
        // send response
